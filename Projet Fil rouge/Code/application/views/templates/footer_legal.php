<!-- Modal -->
<div class="modal fade" id="LegalMentionsModal">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body text-center">
              <div>
                  ...
                  <p>Nom du site web : Locaauto
                  <p>
                  <p>Adresse : www.locaauto.com</p>
                  <p>Propriétaire : TitouInc</p>
                  <p>Responsable de publication : Catherine @LAMANU</p>
              </div>

              <div>Conception et réalisation : LocaautoInc</p>
                  <p>Animation : LocaautoInc </p>
                  <p>Hébergement : LesVoituresDAlexis</p>

                  <p> MunchInc – SAS au capital de 235 cars – RCS 3.4.5.6 –
                      Kaamelott 22, 4335 Durendal, Britain
                      </p>
                  <p> webmaster@locaautoMe.com </p>
              ...
              <p>Freepik</p>
              <p>FontAwesome</p>
              <p>CDN utilisés : Bootstrap 5, Font Awesome, AOS.</p>
          </div>
      </div>
